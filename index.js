...
console.log('Task 5a:', finals2014[0]['Win conditions']);
...
function getFinals(arr) {
    const finalsTeams = arr.filter(function(item){
...
console.log(getWinners(fifaData, getFinals, getYears, getWinners))
...
function getAverageGoals(getFinalsCB) {
 ...
 console.log('task 6', getFinals(fifaData))
